...
(function(vue) {
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$6], ["__file", "D:/前端/毕业季/--2023/pages/index/index.vue"]]);
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", { class: "root" }, [
          vue.createElementVNode("view", { class: "top-text" }, [
            vue.createElementVNode("text", null, "文案")
          ]),
          vue.createElementVNode("view", { class: "bottom" }, [
            vue.createElementVNode("view", { class: "weapon-bar" }, [
              vue.createElementVNode("view", {
                class: "weapon-some",
                onClick: _cache[0] || (_cache[0] = ($event) => tmpGoSeven())
              }, [
                vue.createElementVNode("image", {
                  src: "/static/image/magic.png",
                  mode: "",
                  style: { "width": "100%", "height": "100%", "borderRadius": "20rpx" }
                })
              ]),
              vue.createElementVNode("view", { class: "weapon-some" }, [
                vue.createElementVNode("image", {
  ...
  const _sfc_main$8 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", { class: "root" }, [
          vue.createElementVNode("image", {
            src: "/static/image/mirror_back.png",
            mode: "",
            style: { "width": "100%", "height": "100%", "position": "absolute", "zIndex": "-1" }
          }),
          vue.createElementVNode("view", { class: "recv-people" }, [
            vue.createElementVNode("image", {
              src: "/static/image/girl_final.png",
              mode: "",
              style: { "width": "100%", "height": "130%" }
            })
          ]),
          vue.createElementVNode("view", { class: "risk-proof" }, [
            vue.createCommentVNode(' 			<image src="../../static/image/reel_row.png" mode="" style="width: 100%; height: 100%;"></image> '),
            vue.createElementVNode("view", { class: "text-title" }, [
              vue.createElementVNode("text", null, "冒险证明")
            ])
          ]),
          vue.createElementVNode("view", {
            class: "recv-btn",
    ...
    setup(__props) {
      ...
      const savePic = () => {
        ...
        html2canvas(page, {
          ...
          let base642 = canvas.toDataURL("image/png");
          const a2 = document.createElement("a");
          a2.href = base642;
          a2.setAttribute("download", "pigeons-download");
          a2.click();
        });
      };
      vue.onMounted(() => {
        let basicInfoDiv = document.querySelector(".head-box");
        formatAppLog("log", "at pages/scene8/scene8.vue:69", basicInfoDiv.clientHeight);
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", { class: "root" }, [
          vue.createElementVNode("image", {
            src: "/static/image/reel_column.png",
            mode: "",
            style: { "width": "120%", "height": "120%", "position": "absolute", "bottom": "-10%", "right": "-11%", "zIndex": "-1" }
          }),
          vue.createElementVNode("view", { class: "info-bar" }, [
            vue.createElementVNode("view", { class: "basic-info" }, [
              ...
              vue.createElementVNode("view", { class: "head-box" }, [
                vue.createElementVNode("image", {
                  src: "/static/face/f1.png",
                  mode: "",
                  style: { "width": "100%", "height": "100%", "borderRadius": "40rpx" }
                })
              ])
            ]),
            vue.createElementVNode("view", { class: "skill-info-one" }, [
              vue.createElementVNode("view", { class: "skill-one-text" }, [
                vue.createElementVNode("text", null, "技能信息1")
              ])
            ]),
            vue.createElementVNode("view", { class: "skill-info-two" }, [
              vue.createElementVNode("view", { class: "skill-two-text" }, [
                vue.createElementVNode("text", null, "技能信息2")
              ])
            ]),
            vue.createElementVNode("view", { class: "talent-info" }, [
              vue.createElementVNode("view", { class: "talent-text" }, [
                vue.createElementVNode("text", null, "天赋信息")
              ])
            ]),
            vue.createElementVNode("view", { class: "enchant-info" }, [
              vue.createElementVNode("view", { class: "enchant-text" }, [
                vue.createElementVNode("text", null, "附魔信息")
              ])
            ])
          ]),
          vue.createElementVNode("view", { class: "bottom-bar" }, [
            vue.createElementVNode("view", {
              class: "save-png",
              onClick: _cache[0] || (_cache[0] = ($event) => savePic())
            }, [
              vue.createElementVNode("text", null, "保存至本地")
            ]),
            vue.createElementVNode("view", {
              class: "ready-btn",
              onClick: _cache[1] || (_cache[1] = ($event) => leaveCity())
            }, [
              vue.createElementVNode("text", null, "我准备好了!")
            ])
          ])
        ]);
      };
  ...
  const PagesScene8Scene8 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-0fa03097"], ["__file", "D:/前端/毕业季/--2023/pages/scene8/scene8.vue"]]);
  const _sfc_main$6 = {
    data() {
      return {
        showNext: 0,
  ...
  const _sfc_main$5 = {
    ...
    methods: {
      ...
      selectCloth(e2) {
        formatAppLog("log", "at pages/scene2_2/scene2_2.vue:98", e2);
      },
      selectHair(e2) {
        formatAppLog("log", "at pages/scene2_2/scene2_2.vue:101", e2);
      }
    },
    mounted() {
      this.cloth = this.cloth_1;
    ...
    methods: {
      ...
      changeSet() {
        ...
        for (let i2 = 0; i2 < 3; i2++) {
          for (let j = 0; j < 4; j++) {
            this.control2[i2][j] = 0;
          }
          this.control2[i2][randomNumbers[i2]] = 1;
        }
      },
      //判断是哪一个图片
      judge(arr) {
      ...
      select(idx) {
        if (this.curStatus < 4) {
          let ID2 = this.judge(this.control2[idx]);
          ID2++;
          for (let i2 = 0; i2 < 4; i2++) {
            if (this.control1[i2][ID2]) {
          ...
          this.control1[this.curStatus][ID2] = 1;
          this.curStatus++;
      ...
      del(idx) {
        if (this.curStatus > 0 && idx == this.curStatus - 1) {
          let ID2 = this.judge(this.control1[idx]);
          this.control1[idx][ID2] = 0;
